    ...
    <div className="p-6 bg-white rounded-lg shadow">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center px-3 py-1 text-purple-700 bg-purple-100 rounded-full">
            <Users size={16} className="mr-1" />
            <span>
              {totalVotes} of {poll.totalStudents || 0} responses
            </span>
          </div>
          {timeLeft > 0 && (
      ...
      <div className="mt-6 text-center">
        <p className="text-gray-600">
          {totalVotes} of {poll.totalStudents || 0} students have responded (
          {totalVotes > 0 && poll.totalStudents > 0 ? Math.round((totalVotes / poll.totalStudents) * 100) : 0}%)
        </p>
      </div>
    </div>
  )
